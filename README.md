...
Veacha is log work project build help to the leader in manege their team work
A simple task manager app built with Laravel 5.6

### Demo

[Veacha](http://veacha.org/)

## Reference ACLS

[User Roles and Permissions Tutorial](https://www.itsolutionstuff.com/post/laravel-58-user-roles-and-permissions-tutorialexample.html).

### How to install 🤔

(1). Veacha [download](https://gitlab.com/karonasrun.ks/veacha/-/archive/master/veacha-master.zip) or clone the repo:

```
git clone https://gitlab.com/karonasrun.ks/veacha.git
```
...
(4) Run the database seeder to roles & permission

```
php artisan db:seed --class=PermissionTableSeeder
```

(5) Run the database seeder to creating Administrator
