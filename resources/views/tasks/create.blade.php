        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    @can('role-create')
                    <li class="breadcrumb-item"><a href="{{ route('projects.show',$id) }}" class="btn btn-primary m-0 pull-left">{{ __('veacha.button_list_project')}}</a>
                    </li>
                    @endcan
                </ol>
            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ticket" class="form-control form-control-sm" placeholder="Enter task" value="{{ old('ticket') }}">
                                </div>
                            </div>                            
                        </div>
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="version" class="form-control form-control-sm" placeholder="Enter version" value="{{ old('version') }}">
                                </div>
                            </div>                            
                        </div>
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="estimate" class="form-control form-control-sm" placeholder="Enter estimate 1h" value="{{ old('estimate') }}">
                                </div>
                            </div>                            
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm textarea" name="description" rows="10" placeholder="Place some text here">{{ old('description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{ __('veacha.button_save_task')}}</button>
                                </div>
                            </div>
                        </div>
                    </form>
